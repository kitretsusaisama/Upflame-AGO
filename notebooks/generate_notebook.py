...
cell_1_code = {
    ...
    "source": [
        ...
        "    !pip install -q transformers datasets sentencepiece accelerate bitsandbytes tqdm\n",
        "\n",
...
cell_4_code = {
    ...
    "source": [
        ...
        "            has_bnb = False\n",
        "\n",
        "        if device_type == 'cuda' and has_bnb:\n",
        "            try:\n",
        "                print(\"Using 8-bit AdamW optimizer\")\n",
        "                optimizer = bnb.optim.AdamW8bit(optim_groups, lr=learning_rate, betas=betas)\n",
        "            except Exception as e:\n",
        "                print(f\"Failed to initialize 8-bit optimizer: {e}. Falling back to standard AdamW.\")\n",
